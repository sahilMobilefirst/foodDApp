...
import { View, FlatList, StyleSheet, Image, Dimensions, TouchableOpacity, Text, Pressable } from 'react-native';
import { introData } from '../utils/data';

const Carousel2 = ({navigation}:any) => {
  ...
  return (
    <View style={styles.container}>
      ...
      />
      <View style={styles.dotsContainer}>{introData.map((_:any, index: number) => renderDot(index))}</View>
